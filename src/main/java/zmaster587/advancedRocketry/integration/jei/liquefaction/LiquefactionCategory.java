...
public class LiquefactionCategory extends MachineCategoryTemplate<LiquefactionWrapper> {

	public LiquefactionCategory(IGuiHelper helper) {
	...
	public String getTitle() {
		return LibVulpes.proxy.getLocalizedString("tile.liquefactionplant.name");
	}
	...
	public void setRecipe(IRecipeLayout recipeLayout,
						  LiquefactionWrapper recipeWrapper, IIngredients ingredients) {
