...
public class TileLiquefactionPlant extends TileMultiblockMachine {
	...
	public static final Object[][][] structure = new Object[][][] {
		...
		{   {Blocks.AIR,                                 Blocks.AIR,                          Blocks.AIR,                          Blocks.AIR},
			{AdvancedRocketryBlocks.blockStructureTower, LibVulpesBlocks.blockStructureBlock, LibVulpesBlocks.blockStructureBlock, AdvancedRocketryBlocks.blockStructureTower},
			{LibVulpesBlocks.motors,                     LibVulpesBlocks.blockStructureBlock, LibVulpesBlocks.blockStructureBlock, AdvancedRocketryBlocks.blockStructureTower}},
		{   {LibVulpesBlocks.blockStructureBlock,        LibVulpesBlocks.blockStructureBlock, 'c',                                 'P'},
			{LibVulpesBlocks.blockStructureBlock,        LibVulpesBlocks.blockStructureBlock, LibVulpesBlocks.blockStructureBlock, LibVulpesBlocks.blockStructureBlock},
			{AdvancedRocketryBlocks.blockStructureTower, LibVulpesBlocks.blockStructureBlock, 'l',                                 AdvancedRocketryBlocks.blockStructureTower}}
	};
	...
	public String getMachineName() {
		return AdvancedRocketryBlocks.blockLiquefactionPlant.getLocalizedName();
	}
