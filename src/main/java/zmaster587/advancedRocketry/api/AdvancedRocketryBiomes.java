...
>>>>>>> Stashed changes
	...
	public static void registerBiomes(RegistryEvent.Register<Biome> evt) {
		...
		evt.getRegistry().registerAll(
				moonBiome.setRegistryName("moon.json"),
	...
	public static Biome getBiome(String string) {
		return getBiomeFromResourceLocation(new ResourceLocation(string));
	}
	...
	public static Biome getBiomeFromResourceLocation(ResourceLocation location) {
		return getBiomeRegistry().getOrDefault(location);
	}

	public static Registry<Biome> getBiomeRegistry() {
		return DynamicRegistries.func_239770_b_().getRegistry(Registry.BIOME_KEY);
	}
