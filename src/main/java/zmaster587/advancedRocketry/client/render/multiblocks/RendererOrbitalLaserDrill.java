...
public class RendererOrbitalLaserDrill extends TileEntityRenderer<TileOrbitalLaserDrill> {
	
	WavefrontObject model;
	ResourceLocation texture =  new ResourceLocation("advancedrocketry","textures/models/orbitallaserdrill.png");
	
	
	public RendererOrbitalLaserDrill(TileEntityRendererDispatcher tile) {
		super(tile);
		try {
